...
export const WEATHER2: RawIdiom[] = [
  ...
  ["a frosty reception", "an unfriendly or cold welcome", "холодный приём", "His proposal got a frosty reception from the board.", "C1"],
  ["out of a clear blue sky", "suddenly and without warning", "совершенно неожиданно", "The news came out of a clear blue sky.", "B2"],
  ["a sunny disposition", "a naturally cheerful and positive personality", "солнечный, жизнерадостный характер", "Everyone loves her sunny disposition.", "B2"],
  ["a hail of criticism", "an overwhelming amount of criticism directed at someone", "шквал критики", "The decision brought a hail of criticism from customers.", "C1"],
];
