...
export const BUSINESS2: RawIdiom[] = [
  ...
  ["a fly-by-night operation", "an unreliable and possibly dishonest business", "сомнительная, недолговечная контора", "Avoid that supplier, it seems like a fly-by-night operation.", "C1"],
  ["read the market", "to understand current trends and conditions in a market", "чувствовать рынок", "Good investors know how to read the market.", "C1"],
  ["a market leader", "the company with the largest share or influence in its market", "лидер рынка", "The firm has been the market leader for a decade.", "B1"],
